...
class DailyReportHistoryPage extends StatefulWidget {
  @override
  State<DailyReportHistoryPage> createState() => _DailyReportHistoryPageState();
}

class _DailyReportHistoryPageState extends State<DailyReportHistoryPage> {
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            // Request floating button bottom right
            Positioned(
              bottom: 20,
              right: 16,
              child: ElevatedButton.icon(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const DailyReportEntryPage()),
                  );
                },
                icon: const Icon(Icons.add, color: Colors.white),
                label:
                    const Text("Request Daily Report", style: TextStyle(color: Colors.white)),
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF346CB0),
                  shape: RoundedRectangleBorder(
