...
//submitattendancepage.dart for the medibiz
// import 'dart:async';
// import 'dart:convert';
// import 'package:flutter/material.dart';
// import 'package:geocoding/geocoding.dart';
...
//     try {
//       final url = Uri.parse('https://medibiz.xelwel.com/api/v1/web_attendance');
//       final response = await http.get(url).timeout(const Duration(seconds: 15));
...
//             SnackBar(
//               content: Text(
//                   'Error loading attendance locations: ${response.statusCode}'),
//               backgroundColor: Colors.red,
//             ),
//           );
//         }
...
// submit attendancepage.dart for the shreenagar
// import 'dart:async';
// import 'dart:convert';
// import 'package:flutter/material.dart';
// import 'package:geocoding/geocoding.dart';
...
//     try {
//       final url = Uri.parse('https://shreenagargroup.smarthajiri.com/api/v1/web_attendance');
//       final response = await http.get(url).timeout(const Duration(seconds: 15));
