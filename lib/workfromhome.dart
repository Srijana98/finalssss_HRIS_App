...
const WorkFromHomeEntryPage({super.key, this.existingData});
  ...
  @override
  State<WorkFromHomeEntryPage> createState() => _WorkFromHomeEntryPageState();
}

class _WorkFromHomeEntryPageState extends State<WorkFromHomeEntryPage> {
  final Color _customBlue = const Color(0xFF346CB0);
  final String _entryType = 'WORKFROMHOME';
  ...
  request.files.add(await http.MultipartFile.fromPath(
    ...
    if (response.statusCode == 200 && result['status'] == 'success') {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: const Text('Work From Home request submitted successfully!'),
        backgroundColor: _customBlue,
      ));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Work From Home Entry",
            style: TextStyle(
                color: Colors.white,
