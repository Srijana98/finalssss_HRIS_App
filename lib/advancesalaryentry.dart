...
//   final List<String> _years = ['2081', '2082', '2083', '2084', '2085'];
...
//     // 'date_type': _takenDateIsBS ? 'BS' : 'AD', // 👈 add this line
//     'date_type': _takenDateIsBS ? 'NP' : 'EN', // 👈 updated as per your requirement
...
//   // ✅ Add form fields (exact names as API expects)
...
// // ✅ Add installments data if it's monthly
...
//     // After successfully submitting the request (or locally saving), you can do this:

// // 1. Create a map/object for the new advance salary entry
// final newAdvanceSalary = {
//   'advance_amount': _advanceAmountController.text,
//   'taken_date': _takenDateController.text,
//   'deduct_type': deductTypeForAPI(_selectedDeductType),
//   'deduct_year': _selectedStartYear ?? '',
//   'deduct_month': (_months.indexOf(_selectedStartMonth ?? '') + 1).toString(),
//   'paid_over': _installmentPeriodController.text.isNotEmpty
//       ? _installmentPeriodController.text
//       : '0',
//   'remarks': _remarksController.text,
//   'installments': _installmentSchedule.isNotEmpty
//       ? jsonEncode(_buildInstallmentListForAPI())
//       : null,
// };


// // 2. Save locally using SharedPreferences
// final prefs = await SharedPreferences.getInstance();
// List<String> savedAdvanceSalary = prefs.getStringList('advance_salary_local') ?? [];
// savedAdvanceSalary.add(jsonEncode(newAdvanceSalary));
// await prefs.setStringList('advance_salary_local', savedAdvanceSalary);

// // 3. Navigate to history page and pass the new data
// Navigator.pushReplacement(
//   context,
//   MaterialPageRoute(
//     builder: (_) => AdvanceSalaryHistoryPage(
//       AdsalaryData: {
//         "data": {
//           "statusWiseHistory": {
//             "Pending": [newAdvanceSalary],
//           }
//         }
//       },
//     ),
...
//   } else {
//     // If API returned 200/201 but status != success
//     ScaffoldMessenger.of(context).showSnackBar(
//       SnackBar(
...
//   }
// } else {
//   // Handle any non-200/201 HTTP code
//   ScaffoldMessenger.of(context).showSnackBar(
//     SnackBar(
...
//   // List<Map<String, String>> _installmentSchedule = [];
...
//     // Example: "2082-Bhadra" → ["2082", "Bhadra"]
//     final parts = item['yearMonth'].split('-');
//     final year = int.tryParse(parts[0]) ?? 0;
//     final monthName = parts.length > 1 ? parts[1] : '';
//     final monthIndex = _months.indexOf(monthName) + 1; // Month as 1–12
...
//     if (_remainingAmount < 0) _remainingAmount = 0; // avoid negative display
//   });
// }
...
// });
// _calculateRemainingAmount(); // ✅ recalculate after generation
...
//       borderSide: BorderSide(color: Color(0xFFCCCCCC)), // grey
//     ),
//     focusedBorder: const UnderlineInputBorder(
//       borderSide: BorderSide(color: Color(0xFFCCCCCC)), // grey even on focus
//     ),
...
//             decoration: _underlineInputDecoration(), // ✅ Calendar icon removed
//           ),
//         ),
//       ),
//       Positioned(
...
//                   child: Center(
//                     child: Text(item['sn']!, style: const TextStyle(fontSize: 13)),
//                   ),
//                 ),
//                 Padding(
//                   padding: const EdgeInsets.symmetric(vertical: 8),
...
//                     onChanged: (value) {
//                       _calculateRemainingAmount(); // ✅ updates whenever user edits
//                     },
//                   ),
//                 ),
//               ],
...
//     onPressed: () {
//       _submitAdvanceSalary(); // ✅ Call your API function here
//     },
...
class AdvanceSalaryEntryPage extends StatefulWidget {
  const AdvanceSalaryEntryPage({super.key});
